...
static void rgb888_toStraight(void *dst, const void *src, size_t pixelCount,
                              const PixelAuxInfo *) {
...
static void rgb888_fromStraight(void *dst, const void *src, size_t pixelCount,
                                const PixelAuxInfo *) {
...
static void bgr888_toStraight(void *dst, const void *src, size_t pixelCount,
                              const PixelAuxInfo *) {
...
static void bgr888_fromStraight(void *dst, const void *src, size_t pixelCount,
                                const PixelAuxInfo *) {
...
static void swap24(void *dst, const void *src, size_t pixelCount,
                   const PixelAuxInfo *) {
