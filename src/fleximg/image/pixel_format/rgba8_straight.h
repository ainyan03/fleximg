...
static void rgba8Straight_toStraight(void *dst, const void *src,
...
static void rgba8Straight_fromStraight(void *dst, const void *src,
                                       size_t pixelCount,
                                       const PixelAuxInfo *) {
...
static void rgba8Straight_blendUnderStraight(void *__restrict__ dst,
  ...
  if (plimit && dstA == 0) {
    ...
    do {
      ...
      reinterpret_cast<uint32_t *>(d)[0] =
          reinterpret_cast<const uint32_t *>(s)[0];
      reinterpret_cast<uint32_t *>(d)[1] =
          reinterpret_cast<const uint32_t *>(s)[1];
      reinterpret_cast<uint32_t *>(d)[2] =
          reinterpret_cast<const uint32_t *>(s)[2];
      reinterpret_cast<uint32_t *>(d)[3] =
          reinterpret_cast<const uint32_t *>(s)[3];
      d += 16;
      dstA = d[3];
      s += 16;
    } while (--plimit);
