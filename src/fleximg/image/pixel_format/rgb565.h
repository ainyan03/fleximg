...
#define RGB565_HIGH_ENTRY(h)                                                   \
  static_cast<uint16_t>((((((h) & 0x07) << 5) | (((h) & 0x07) >> 1)) << 8) |   \
                        ((((h) >> 3) << 3) | (((h) >> 3) >> 2)))

// 下位バイト用エントリ: uint16_t値 = (G_low << 8) | B8
#define RGB565_LOW_ENTRY(l)                                                    \
  static_cast<uint16_t>((((((l) >> 5) & 0x07) << 2) << 8) |                    \
                        ((((l) & 0x1F) << 3) | (((l) & 0x1F) >> 2)))

#define RGB565_HIGH_ROW(base)                                                  \
  RGB565_HIGH_ENTRY(base + 0), RGB565_HIGH_ENTRY(base + 1),                    \
      RGB565_HIGH_ENTRY(base + 2), RGB565_HIGH_ENTRY(base + 3),                \
      RGB565_HIGH_ENTRY(base + 4), RGB565_HIGH_ENTRY(base + 5),                \
      RGB565_HIGH_ENTRY(base + 6), RGB565_HIGH_ENTRY(base + 7),                \
      RGB565_HIGH_ENTRY(base + 8), RGB565_HIGH_ENTRY(base + 9),                \
      RGB565_HIGH_ENTRY(base + 10), RGB565_HIGH_ENTRY(base + 11),              \
      RGB565_HIGH_ENTRY(base + 12), RGB565_HIGH_ENTRY(base + 13),              \
      RGB565_HIGH_ENTRY(base + 14), RGB565_HIGH_ENTRY(base + 15)

#define RGB565_LOW_ROW(base)                                                   \
  RGB565_LOW_ENTRY(base + 0), RGB565_LOW_ENTRY(base + 1),                      \
      RGB565_LOW_ENTRY(base + 2), RGB565_LOW_ENTRY(base + 3),                  \
      RGB565_LOW_ENTRY(base + 4), RGB565_LOW_ENTRY(base + 5),                  \
      RGB565_LOW_ENTRY(base + 6), RGB565_LOW_ENTRY(base + 7),                  \
      RGB565_LOW_ENTRY(base + 8), RGB565_LOW_ENTRY(base + 9),                  \
      RGB565_LOW_ENTRY(base + 10), RGB565_LOW_ENTRY(base + 11),                \
      RGB565_LOW_ENTRY(base + 12), RGB565_LOW_ENTRY(base + 13),                \
      RGB565_LOW_ENTRY(base + 14), RGB565_LOW_ENTRY(base + 15)

// RGB565上位バイト用テーブル (256 × 2 = 512 bytes): (G_high << 8) | R8
alignas(64) static const uint16_t rgb565HighTable[256] = {
    RGB565_HIGH_ROW(0x00), RGB565_HIGH_ROW(0x10), RGB565_HIGH_ROW(0x20),
    RGB565_HIGH_ROW(0x30), RGB565_HIGH_ROW(0x40), RGB565_HIGH_ROW(0x50),
    RGB565_HIGH_ROW(0x60), RGB565_HIGH_ROW(0x70), RGB565_HIGH_ROW(0x80),
    RGB565_HIGH_ROW(0x90), RGB565_HIGH_ROW(0xa0), RGB565_HIGH_ROW(0xb0),
    RGB565_HIGH_ROW(0xc0), RGB565_HIGH_ROW(0xd0), RGB565_HIGH_ROW(0xe0),
    RGB565_HIGH_ROW(0xf0)};

// RGB565下位バイト用テーブル (256 × 2 = 512 bytes): (G_low << 8) | B8
alignas(64) static const uint16_t rgb565LowTable[256] = {
    RGB565_LOW_ROW(0x00), RGB565_LOW_ROW(0x10), RGB565_LOW_ROW(0x20),
    RGB565_LOW_ROW(0x30), RGB565_LOW_ROW(0x40), RGB565_LOW_ROW(0x50),
    RGB565_LOW_ROW(0x60), RGB565_LOW_ROW(0x70), RGB565_LOW_ROW(0x80),
    RGB565_LOW_ROW(0x90), RGB565_LOW_ROW(0xa0), RGB565_LOW_ROW(0xb0),
    RGB565_LOW_ROW(0xc0), RGB565_LOW_ROW(0xd0), RGB565_LOW_ROW(0xe0),
    RGB565_LOW_ROW(0xf0)};
...
#define RGB565LE_TO_STRAIGHT_PIXEL(s_off, d_off)                               \
  do {                                                                         \
    ...
    *reinterpret_cast<uint16_t *>(&d[d_off]) =                                 \
        static_cast<uint16_t>(h16 + (l16 & 0xFF00));                           \
  } while (0)
...
#define RGB565LE_TO_STRAIGHT_PIXEL_x2(s_off, d_off)                            \
  do {                                                                         \
    ...
    *reinterpret_cast<uint16_t *>(&d[d_off]) =                                 \
        static_cast<uint16_t>(h16_0 + (l16_0 & 0xFF00));                       \
    d[d_off + 2] = static_cast<uint8_t>(l16_0);                                \
    d[d_off + 3] = 255;                                                        \
    *reinterpret_cast<uint16_t *>(&d[d_off + 4]) =                             \
        static_cast<uint16_t>(h16_1 + (l16_1 & 0xFF00));                       \
    d[d_off + 6] = static_cast<uint8_t>(l16_1);                                \
    d[d_off + 7] = 255;                                                        \
  } while (0)

static void rgb565le_toStraight(void *__restrict__ dst,
...
#define RGBA8_TO_RGB565_LE(rgba)                                               \
  (((((rgba) >> 3) << 6) + (((rgba) >> 10) & 0x3F)) << 5) +                    \
      (((rgba) >> 19) & 0x1F)

static void rgb565le_fromStraight(void *__restrict__ dst,
...
static void rgb565be_toStraight(void *__restrict__ dst,
                                const void *__restrict__ src, size_t pixelCount,
                                const PixelAuxInfo *) {
...
static void rgb565be_fromStraight(void *__restrict__ dst,
                                  const void *__restrict__ src,
                                  size_t pixelCount, const PixelAuxInfo *) {
...
static void swap16(void *dst, const void *src, size_t pixelCount,
                   const PixelAuxInfo *) {
