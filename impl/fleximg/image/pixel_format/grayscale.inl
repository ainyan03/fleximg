/**
 * @file grayscale.inl
 * @brief Grayscale ピクセルフォーマット 実装
 * @see src/fleximg/image/pixel_format/grayscale.h
 */
...
template <int BitsPerPixel, BitOrder Order>
static void grayscaleN_toStraight(void *__restrict__ dst, const void *__restrict__ src, size_t pixelCount,
                                  const PixelAuxInfo *aux)
{
    ...
    bit_packed_detail::unpackIndexBits<BitsPerPixel, Order>(grayData, s, pixelCount, pixelOffsetInByte);
...
template <int BitsPerPixel, BitOrder Order>
static void grayscaleN_fromStraight(void *__restrict__ dst, const void *__restrict__ src, size_t pixelCount,
                                    const PixelAuxInfo *)
{
