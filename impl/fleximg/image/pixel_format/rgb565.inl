/**
 * @file rgb565.inl
 * @brief RGB565 ピクセルフォーマット 実装
 * @see src/fleximg/image/pixel_format/rgb565.h
 */
...
// RGB565上位バイト用テーブル (256 x 2 = 512 bytes): (G_high << 8) | R8
...
// RGB565下位バイト用テーブル (256 x 2 = 512 bytes): (G_low << 8) | B8
